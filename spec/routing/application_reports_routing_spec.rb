...
describe 'routes for ApplicationReport', type: :routing do
  #it 'routes /' do
    #expect(get('/')).to route_to('application_reports#index')
  #end
  ...
  #it 'routes /application_reports/10 to the application_reports controller' do
    #expect(get('/application_reports/10')).not_to be_routable
  #end
  ...
  #it 'routes /application_reports/download to the application_reports controller' do
    #expect(get('/application_reports/download')).to route_to('application_reports#download')
  #end
end
